...
namespace CC.Business.ProfileManager.WebApi.CribisComX.Controllers
{
    ...
    /// </summary>
    /// <seealso cref="CC.Core.Web.Controllers.CCBaseController{MarketLabController, ServiceRegistry}" />
    [Route("[controller]/[action]")]
    public class MarketLabController : CCBaseController<MarketLabController, ServiceRegistry>
    {
        ...
        public MarketLabController(IServiceRegistry serviceRegistry, ICCLogger logger,
        ...
        /*
        /// <summary>
        /// Gets the market lab profile.
        /// </summary>
        /// <returns></returns>
        [HttpGet]
        public POCO.MarketLabProfile GetMarketLabProfile()
        {
            var pm = ProfileStore<ML>.GetProfileManager(configurationProxy.ConfigurationObject.ProfileStoreConnectionString);
            var profile = pm.GetProfile(userProfileManger.UserNameDistinguishName.ToString(), "W",
                configurationProxy.ConfigurationObject.MarketLabProfileNamespace);
            return Mapper.MarketLabProfile.Map(profile);
        }
        */
