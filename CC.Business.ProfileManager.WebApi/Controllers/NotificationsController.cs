...
namespace CC.Business.ProfileManager.WebApi.CribisComX.Controllers
{
    ...
    public class NotificationsController : CCBaseController<NotificationsController, ServiceRegistry>
    {
        ...
        public NotificationsController(IServiceRegistry serviceRegistry, ICCLogger logger,
        ...
        /// <returns></returns>
        [HttpGet]
        public POCO.NotificationsProfile GetNotificationsProfile()
        {
            var pm = ProfileStore<Core.CribisComX.BusinessObjects.NTP>.GetProfileManager(configurationProxy.ConfigurationObject.ProfileStoreConnectionString);
            var profile = pm.GetProfile(userProfileManger.UserNameDistinguishName.ToString(), "W",
                configurationProxy.ConfigurationObject.NotificationsProfileNamespace);
            return Mapper.NotificationsProfile.Map(profile);
        }
        */
